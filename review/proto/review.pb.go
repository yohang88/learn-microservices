...
func (x *GetReviewListRequest) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *GetReviewListResponse) GetReviews() []*Review {
	if x != nil {
		return x.Reviews
	}
	return nil
...
var file_proto_review_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x22, 0x35, 0x0a, 0x14,
	0x47, 0x65, 0x74, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	...
	0x74, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x06, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x18, 0x0a,
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x41, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x52, 0x65,
	0x76, 0x69, 0x65, 0x77, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	,
...
var file_proto_review_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_review_proto_goTypes = []interface{}{
	(*GetReviewListRequest)(nil),  // 0: review.GetReviewListRequest
	(*Review)(nil),                // 1: review.Review
	(*GetReviewListResponse)(nil), // 2: review.GetReviewListResponse
}
var file_proto_review_proto_depIdxs = []int32{
	1, // 0: review.GetReviewListResponse.reviews:type_name -> review.Review
	0, // 1: review.ReviewService.GetReviewList:input_type -> review.GetReviewListRequest
	2, // 2: review.ReviewService.GetReviewList:output_type -> review.GetReviewListResponse
...
func file_proto_review_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_review_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_review_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Review); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_review_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
...
func (c *reviewServiceClient) GetReviewList(ctx context.Context, in *GetReviewListRequest, opts ...grpc.CallOption) (*GetReviewListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/review.ReviewService/GetReviewList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReviewService_GetReviewList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/review.ReviewService/GetReviewList",
	}
